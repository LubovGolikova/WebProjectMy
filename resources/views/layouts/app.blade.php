...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form class="form-inline my-2 my-lg-0 ">
        <input class="form-control mr-sm-2"  autocomplete="off" contenteditable="true" spellcheck="false" type="search" placeholder="Поиск" aria-label="Search">
...
<footer class="container footer-color d-flex flex-row justify-content-center align-items-center">
        <div class="col-3">
        <h3>О нас</h3>
        </div>
        <div class="col-3">
